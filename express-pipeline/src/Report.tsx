...
import { OpenClaimVideoProps, ToggleShowMoreComponentProps, Report, ReportProps } from "tttc-common/components/Report/Report.js";
...
export default function ReportSSR({data}:ReportProps) {
    return <Report data={data} ToggleShowMoreComponent={ServerSideToggleShowMoreButton} OpenClaimVideo={ServerSideOpenClaimVideo} />
}