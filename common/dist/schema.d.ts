...
export declare const cache: z.ZodObject<
  {
    ...
    set: z.ZodFunction<
      z.ZodTuple<[z.ZodString, z.ZodAny], z.ZodUnknown>,
      z.ZodVoid
    >;
  },
  "strip",
...
export declare const subtopic: z.ZodObject<
  {
    ...
    claims: z.ZodOptional<
      z.ZodArray<z.ZodType<Claim, z.ZodTypeDef, Claim>, "many">
    >;
  },
  "strip",
  z.ZodTypeAny,
...
export declare const taxonomy: z.ZodArray<
  z.ZodObject<
    {
      topicName: z.ZodString;
      topicShortDescription: z.ZodOptional<z.ZodString>;
...
export declare const sourceMap: z.ZodRecord<
  z.ZodString,
  z.ZodObject<
    {
      comment: z.ZodString;
