    ...
    <section className="max-w-7xl mx-auto px-8 lg:px-28 pb-16">
      ...
      <Bullets>
        ...
        <li>
          ...
          &ldquo;Zero Data Retention&rdquo; service tier, and therefore we
          cannot offer an opt-out of this temporary retention.
        </li>
      </Bullets>
      ...
      <Paragraph>
        ...
        providers including OpenAI, Google Cloud Platform, Posthog, and Weights
        and Biases for processing. We do not share, sell, or distribute your
        data to any entity.
      </Paragraph>
      ...
      <Bullets>
        ...
        <li>
          ...
          lodge a complaint with a supervisory authority. California residents
          have rights under the CCPA, including access to and deletion of
          personal information, the right to know what data is collected, and
          the right to request that data not be sold or shared.
        </li>
        <li>
      ...
      <Bullets>
        ...
        <li>
          ...
          OpenAI models) are subject to OpenAI&apos;s terms of service and
          usage policies.
        </li>
      </Bullets>
