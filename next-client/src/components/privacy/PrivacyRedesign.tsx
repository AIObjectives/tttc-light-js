    ...
    <section className="max-w-7xl mx-auto px-8 lg:px-28 pb-16">
      ...
      <Bullets>
        ...
        <li>
          ...
          uses data submitted via API for long-term improvement of their models.
          ...
          and{" "}
          <a
            href="https://privacy.claude.com/en/articles/7996866-how-long-do-you-store-personal-data"
            target="_blank"
            rel="noopener noreferrer"
            className="text-indigo-600 hover:underline"
          >
          ...
          of monitoring for fraud and abuse. After this period, the data are
          deleted.
        </li>
        <li>
          No-Opt Out of Retention: Participants should be aware that this 30-day
          retention is a standard condition of using both OpenAI&apos;s and
          Anthropic&apos;s commercial APIs. At this time, Talk to the City does
          not qualify for either provider&apos;s &ldquo;Zero Data
          Retention&rdquo; service tier, and therefore we cannot offer an
      ...
      <Paragraph>
        ...
        providers including OpenAI, Anthropic, Google Cloud Platform, Posthog,
      ...
      <Bullets>
        ...
        <li>
          ...
          information, the right to know what data are collected, and the right
      ...
      <Bullets>
        ...
        <li>
          AI responses: Outputs generated by an external AI (currently OpenAI
          and Anthropic models) are subject to the relevant provider&apos;s
